...
\input{mainmatter/evaluation/strategies.tex}
\input{mainmatter/evaluation/metrics.tex}
\clearpage
\input{mainmatter/evaluation/results.tex}
\clearpage
...
% We found that, even though we trained the NN for bib detectedtion only, the NN learned to link the bib with an actual person. Therefore, without the added padding on the person crops, we noticed that the bib detection would fail. If we added the padding, the detection was good.
